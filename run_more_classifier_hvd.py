...
label_dict = {"内容":"0","意义":"1", "主张":"2", "背景":"3", "原因":"4"}
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  output_weights = tf.get_variable(
      "output_weights", [2,hidden_size], # num_labels
  ...
  final_output_weights = tf.get_variable(
      "final_output_weights", [num_labels, 2],
      initializer=tf.truncated_normal_initializer(stddev=0.02))

  final_output_bias = tf.get_variable(
      "final_output_bias", [num_labels], initializer=tf.zeros_initializer())
  ...
  with tf.variable_scope("loss"):
    ...
    logits = tf.nn.bias_add(final_logits, final_output_bias)
